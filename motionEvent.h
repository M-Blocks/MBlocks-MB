...
bool motionEvent_startEBrakePlaneChange(uint16_t bldcSpeed_rpm, uint16_t ebrakeTime_ms, int16_t bldcSpeedChange_rpm, int16_t ebrakeTimeChange_ms, bool reverse, app_sched_event_handler_t motionEventHandler);
