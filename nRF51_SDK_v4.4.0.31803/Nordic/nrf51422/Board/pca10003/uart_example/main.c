...
/** @file
 * @defgroup uart_example_pca10003_main main.c
 * @{
 * @ingroup uart_example_pca10003
 *
...
/** @brief Function for setting @ref ERROR_PIN to one and enters an infinite loop. This function is called if any of the
