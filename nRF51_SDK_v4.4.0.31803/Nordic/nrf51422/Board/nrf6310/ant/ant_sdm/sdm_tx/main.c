...
/**@file
 * @brief ANT Stride and Distance Monitor TX example.
 ...
 *
 * The Stride and Distance Monitor (SDM) master implements all of the features, 
 * which are required for the transmitter to be compliant with the ANT+ SDM profile, 
 ...
 *
 * @image html sdm_tx_flowchart.png "SDM TX flowchart"
 *
 * @par Logging 
 *
 * For logging UART will be the primary display. Data will be printed after broadcast data is 
 * set. Depending on the page transmitted, the following data will be logged:
 ...
 * by removing TRACE_UART from the compiler flags.
 *
...
int main(void)
{
    ...
    err_code = sd_nvic_SetPriority(PROTOCOL_EVENT_IRQn, 
